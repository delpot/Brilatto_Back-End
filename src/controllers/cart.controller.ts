...
class CartController {
  ...
  async getUserCart(req: Request, res: Response) {
    return cartService
      .getCartByUserId(req.params.userId)
      .then((cart) => {
  ...
  async createCart(req: Request, res: Response) {
    ...
    return cartService
      .createCartEntity(userId, jewels, total)
      .save()
      .then((createdCart) => {
  ...
  async updateCart(req: Request, res: Response) {
    return cartService
      .getCartByIdAndUpdate(req.params.id, req.body)
      .then((updatedCart) => {
  ...
  async hardDeleteCart(req: Request, res: Response) {
    return cartService
      .getCartByIdAndHardDelete(req.params.id)
      .then((deletedCart) => {
