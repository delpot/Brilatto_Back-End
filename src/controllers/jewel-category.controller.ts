...
class CategoryController {
  ...
  async createCategory(req: Request, res: Response) {
    ...
    return categoryService
      .createJewelCategory(name, photo, description)
      .save()
  ...
  async updateCategory(req: Request, res: Response) {
    return categoryService
      .getCategoryByIdAndUpdate(req.params.id, req.body)
  ...
  async softDeleteCategory(req: Request, res: Response) {
    return categoryService
      .getCategoryByIdAndSoftDelete(req.params.id)
  ...
  async hardDeleteCategory(req: Request, res: Response) {
    return categoryService
      .getCategoryByIdAndHardDelete(req.params.id)
